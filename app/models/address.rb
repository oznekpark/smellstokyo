class Address < ApplicationRecord
  ...
  validates :destination_first_name, :destination_family_name, presence: true, format: { with: VALID_NAME_REGEX }
  validates :destination_first_name_kana, :destination_family_name_kana, presence: true, format: { with: VALID_KANA_REGEX }
